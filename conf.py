...
BLOG_AUTHOR = "Vilnius Python community"  # (translatable)
BLOG_TITLE = "VilniusPy"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://vilniuspy.lt/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://vilniuspy.lt"
BLOG_EMAIL = "info@vilniuspy.lt"
BLOG_DESCRIPTION = "Vilnius Python community website."  # (translatable)
